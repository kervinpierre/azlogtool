...
import nyc.citymsp.tools.azlogtool.entity.AZLTRadCheck_;
 ...
 */
public final class AZLTRadCheckSpecifications
{
    private static final Logger LOGGER = LogManager.getLogger(
            AZLTRadCheckSpecifications.class);

    public static Specification<AZLTRadCheck> runRadCheckFilterQuery(
                                                final String logic,
                                                final String field1,
                ...
                && StringUtils.isNoneBlank(value))
        {
            switch( operator )
            {
                case "eq":
                {
                    ...
                    {
                        case "username":
                            res = cb.equal(root.get(AZLTRadCheck_.username), value);
                            break;
                    }
                }
                break;
                ...
                case "neq":
                {
                    ...
                    {
                        case "username":
                            res = cb.notEqual(root.get(AZLTRadCheck_.username), value);
                            break;
                    }
                }
                break;
                ...
                case "contains":
                {
                    ...
                    {
                        case "username":
                            res = cb.like(root.get(AZLTRadCheck_.username),
                ...
                case "doesnotcontain":
                {
                    ...
                    {
                        case "username":
                            res = cb.notLike(root.get(AZLTRadCheck_.username),
                                    String.format("%%%s%%",value));
                            break;
                    }
                }
